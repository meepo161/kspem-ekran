...
import ru.avem.ekran.controllers.Test6Controller
...
import ru.avem.ekran.utils.transitionRight
import tornadofx.*
    ...
    private val topSide = anchorpane {
        vbox(spacing = 48.0) {
            ...
            tableview(controller.tableValues) {
                ...
                column("R", TableValuesTest6::R.getter)
                column("L", TableValuesTest6::L.getter)
                column("C", TableValuesTest6::C.getter)
                column("DCR", TableValuesTest6::DCR.getter)
